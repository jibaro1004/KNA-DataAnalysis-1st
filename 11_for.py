...
for i in range(0, 11, 3):
    print(i)  # 0, 3, 6, 9 > 4번 출력

# range 함수에 전달한 두 번째 인자인 끝 값 11은 반복 횟수가 아님
# 반복을 수행할 범위

# ============================================================
print("====== 실습 1. range로 숫자 흐름 출력하기 =====")
...
# for문, if문, 나머지연산자
# 4 % 3 == 0
print(3 % 3)  # 0 > 사과 3개를 3개의 봉지에 균등히 나눠담으면 못 담는 사과는 0개
print(4 % 3)  # 1 > 사과 4개를 3개의 봉지에 균등히 나눠담으면 못 담는 사과는 1개
print(5 % 3)  # 1 > 사과 5개를 3개의 봉지에 균등히 나눠담으면 못 담는 사과는 2개
print(6 % 3)  # 1 > 사과 6개를 3개의 봉지에 균등히 나눠담으면 못 담는 사과는 0개
